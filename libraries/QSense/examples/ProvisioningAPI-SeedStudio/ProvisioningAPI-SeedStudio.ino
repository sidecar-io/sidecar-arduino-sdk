...
// Please Note: To use Seed Studio Ethernet driver, you need to edit the 
// QSense.h file in the QSense library and set USE_Ethernet_Shield_V2 to 1
...
void initSidecar()
{
  ...
  Serial.print( apiKey );
  Serial.println( F( " and secret provided." ) );
